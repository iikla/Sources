...
namespace EyeStepPackage
{
  public class util
  {
    ...
    public static uint setPageProtect([In] int obj0, [In] uint obj1, int count = -1)
    {
      uint lpOldProtect = 0;
      imports.VirtualProtectEx(EyeStep.handle, obj0, count, obj1, ref lpOldProtect);
      return lpOldProtect;
    }
    ...
    public static uint getPageProtect(int address)
    {
      ...
      imports.VirtualQueryEx(EyeStep.handle, address, out lpBuffer, 28U);
      return lpBuffer.Protect;
    }

    public static void writeByte([In] int obj0, byte value)
    {
      byte[] lpBuffer = new byte[1]{ value };
      imports.WriteProcessMemory(EyeStep.handle, obj0, lpBuffer, lpBuffer.Length, ref util.nothing);
    }

    public static void writeBytes([In] int obj0, byte[] value, [In] int obj2) => imports.WriteProcessMemory(EyeStep.handle, obj0, value, obj2 == -1 ? value.Length : obj2, ref util.nothing);

    public static void writeString(int address, string value, [In] int obj2)
    {
      ...
      imports.WriteProcessMemory(EyeStep.handle, address, lpBuffer, obj2 == -1 ? value.Length : obj2, ref util.nothing);
    }

    public static void writeUnicodeString([In] int obj0, string value, [In] int obj2)
    {
      byte[] bytes = Encoding.Unicode.GetBytes(value.ToCharArray(0, value.Length));
      imports.WriteProcessMemory(EyeStep.handle, obj0, bytes, obj2 == -1 ? value.Length * 2 : obj2 * 2, ref util.nothing);
    }
    ...
    public static int createRoutine([In] int obj0, [In] byte obj1)
    {
      ...
      int num3 = imports.VirtualAllocEx(EyeStep.handle, 0, 256, 12288U, 64U);
      if (num3 == 0)
      ...
      switch (convention)
      {
        case 0:
          for (int index4 = (int) obj1 * 4 + 8; index4 > 8; index4 -= 4)
          {
            ...
            int index7 = num8;
            num6 = index7 + 1;
            int num9 = (int) (byte) (index4 - 4);
            numArray7[index7] = (byte) num9;
          }
          byte[] numArray8 = numArray1;
          int index8 = num6;
          int num10 = index8 + 1;
          numArray8[index8] = (byte) 232;
          byte[] bytes1 = BitConverter.GetBytes(num1 - (num3 + num10 + 4));
          byte[] numArray9 = numArray1;
          int index9 = num10;
          int num11 = index9 + 1;
          int num12 = (int) bytes1[0];
          numArray9[index9] = (byte) num12;
          byte[] numArray10 = numArray1;
          int index10 = num11;
          int num13 = index10 + 1;
          int num14 = (int) bytes1[1];
          numArray10[index10] = (byte) num14;
          byte[] numArray11 = numArray1;
          int index11 = num13;
          int num15 = index11 + 1;
          int num16 = (int) bytes1[2];
          numArray11[index11] = (byte) num16;
          byte[] numArray12 = numArray1;
          int index12 = num15;
          int num17 = index12 + 1;
          int num18 = (int) bytes1[3];
          numArray12[index12] = (byte) num18;
          ...
          int index15 = num20;
          num6 = index15 + 1;
          int num21 = (int) (byte) ((uint) obj1 * 4U);
          numArray15[index15] = (byte) num21;
          break;
        case 1:
          for (int index4 = (int) obj1 * 4 + 8; index4 > 8; index4 -= 4)
          {
          ...
          byte[] bytes2 = BitConverter.GetBytes(num1 - (num3 + num22 + 4));
          byte[] numArray17 = numArray1;
          int index17 = num22;
          int num23 = index17 + 1;
          int num24 = (int) bytes2[0];
          numArray17[index17] = (byte) num24;
          byte[] numArray18 = numArray1;
          int index18 = num23;
          int num25 = index18 + 1;
          int num26 = (int) bytes2[1];
          numArray18[index18] = (byte) num26;
          byte[] numArray19 = numArray1;
          int index19 = num25;
          int num27 = index19 + 1;
          int num28 = (int) bytes2[2];
          numArray19[index19] = (byte) num28;
          byte[] numArray20 = numArray1;
          int index20 = num27;
          num6 = index20 + 1;
          int num29 = (int) bytes2[3];
        ...
        case 2:
          ...
          byte[] bytes3 = BitConverter.GetBytes(num1 - (num3 + num38 + 4));
        ...
        case 3:
          ...
          byte[] bytes4 = BitConverter.GetBytes(num1 - (num3 + num52 + 4));
          byte[] numArray41 = numArray1;
          int index41 = num52;
          int num53 = index41 + 1;
          int num54 = (int) bytes4[0];
          numArray41[index41] = (byte) num54;
          byte[] numArray42 = numArray1;
          int index42 = num53;
          int num55 = index42 + 1;
          int num56 = (int) bytes4[1];
          numArray42[index42] = (byte) num56;
          byte[] numArray43 = numArray1;
          int index43 = num55;
          int num57 = index43 + 1;
          int num58 = (int) bytes4[2];
          numArray43[index43] = (byte) num58;
          byte[] numArray44 = numArray1;
          int index44 = num57;
          int num59 = index44 + 1;
          int num60 = (int) bytes4[3];
          numArray44[index44] = (byte) num60;
      ...
      else
      {
        ...
        int index5 = num7;
        int num8 = index5 + 1;
        int num9 = (int) (byte) ((uint) obj1 * 4U);
      ...
      util.writeBytes(num3, numArray1, num61);
      util.savedRoutines.Add(num3);
      return num3;
    }
    ...
    public static List<int> debug_r32([In] int obj0, byte at, int aob, int mask)
    {
      ...
      int lpAddress = imports.VirtualAllocEx(EyeStep.handle, 0, 256, 4096U, 64U);
      int num1 = lpAddress + 128;
      int address = lpAddress + 124;
      ...
      for (int index3 = 0; index3 < mask; ++index3)
      {
        ...
        if (aob == 0)
        {
          ...
          int index5 = num6;
          num5 = index5 + 1;
          int num7 = (int) (byte) (192U + (uint) at);
        ...
        else if (aob + mask * 4 < 128)
        {
          ...
          int index5 = num6;
          int num7 = index5 + 1;
          int num8 = (int) (byte) (64U + (uint) at);
          numArray6[index5] = (byte) num8;
          byte[] numArray7 = numArray2;
          int index6 = num7;
          num5 = index6 + 1;
          int num9 = (int) (byte) (aob + index3 * 4);
        ...
        else
        {
          ...
          int index5 = num6;
          int num7 = index5 + 1;
          int num8 = (int) (byte) (128U + (uint) at);
          numArray6[index5] = (byte) num8;
        ...
        byte[] bytes1 = BitConverter.GetBytes(num1 + index3 * 4);
        byte[] numArray12 = numArray2;
        int index11 = num16;
        int num17 = index11 + 1;
        int num18 = (int) bytes1[0];
        numArray12[index11] = (byte) num18;
        byte[] numArray13 = numArray2;
        int index12 = num17;
        int num19 = index12 + 1;
        int num20 = (int) bytes1[1];
        numArray13[index12] = (byte) num20;
        byte[] numArray14 = numArray2;
        int index13 = num19;
        int num21 = index13 + 1;
        int num22 = (int) bytes1[2];
        numArray14[index13] = (byte) num22;
        byte[] numArray15 = numArray2;
        int index14 = num21;
        num4 = index14 + 1;
        int num23 = (int) bytes1[3];
        numArray15[index14] = (byte) num23;
      }
      ...
      int index17 = num25;
      int num26 = index17 + 1;
      int num27 = (int) bytes2[0];
      numArray18[index17] = (byte) num27;
      byte[] numArray19 = numArray2;
      int index18 = num26;
      int num28 = index18 + 1;
      int num29 = (int) bytes2[1];
      numArray19[index18] = (byte) num29;
      byte[] numArray20 = numArray2;
      int index19 = num28;
      int num30 = index19 + 1;
      int num31 = (int) bytes2[2];
      numArray20[index19] = (byte) num31;
      byte[] numArray21 = numArray2;
      int index20 = num30;
      int num32 = index20 + 1;
      int num33 = (int) bytes2[3];
      numArray21[index20] = (byte) num33;
      ...
      util.writeBytes(lpAddress, numArray2, num39);
      util.placeTrampoline(obj0, lpAddress, num39);
      while (util.readInt(address) == 0)
        Thread.Sleep(10);
      for (int index3 = 0; index3 < mask; ++index3)
        intList.Add(util.readInt(num1 + index3 * 4));
      uint num40 = util.setPageProtect(obj0, 64U, 1);
      util.writeBytes(obj0, numArray1, to);
      int num41 = (int) util.setPageProtect(obj0, num40, 1);
      imports.VirtualFreeEx(EyeStep.handle, lpAddress, 0, 32768U);
      return intList;
    }
