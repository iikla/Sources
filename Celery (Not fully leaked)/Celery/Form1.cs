...
namespace Celery
{
  public class Form1 : Form
  {
    ...
    private static extern void mouse_event([In] int obj0, int b, int t, [In] int obj3, [In] int obj4);
    ...
    public void form_resizeend(object sender, EventArgs e)
    {
      this.form_resizing = false;
      this.form_resize_start = new Size(this.Width, this.Height);
    }
    ...
    private void pictureBox2_Click([In] object obj0, EventArgs e) => Environment.Exit(0);
    ...
    private void timer2_Tick(object sender, EventArgs e) => this.lbl_logo.Text = "Initializing.";
    ...
    private void button1_Click(object sender, EventArgs e)
    {
      ...
      if (EyeStep.handle != 0 && this.lbl_logo.Text == "[ celery - injected ]")
      {
        ...
        int num2 = imports.VirtualAllocEx(EyeStep.handle, 0, length, 4096U, 64U);
        util.writeString(num2, text, length);
        util.writeUInt(procAddress + 8, 1U);
        util.writeInt(procAddress + 12, num2);
        util.writeInt(procAddress + 16, length);
    ...
    private void richTextBox1_KeyPress(object sender, KeyPressEventArgs e)
    {
      ...
      if (str1.ToLower() == "cmds")
      {
        this.txt_editor.Text = "Sorry, commands N/A\nSend suggestions to the Celery discord server!\n";
        this.update_output_colors();
      }
      else if (str1.ToLower() == "help")
        this.txt_editor.Text = "[Celery] Type \"cmds\" to view commands";
      else if ((str1.ToLower() + "         ").Substring(0, 9) == "setfflag ")
      {
        int num1 = (int) MessageBox.Show("Sorry, this command is in beta");
        int num2 = 9;
        string str2 = "";
        for (; num2 < str1.Length; ++num2)
        {
          if (str1[num2] != ' ')
          {
            str2 += str1[num2].ToString();
          }
          else
          {
            ++num2;
        ...
        string str3 = str1.Substring(num2, str1.Length - num2);
        int num3 = (int) MessageBox.Show("Tried to set FFlag '" + str2 + "' to " + str3);
      }
      else
      {
        if (!(str1.ToLower() == "resetfflags"))
          return;
        int num = (int) MessageBox.Show("Sorry, this command is in beta");
      }
    }
    ...
    private void button8_Click(object sender, EventArgs e)
    {
      ...
      int num2 = imports.VirtualAllocEx(EyeStep.handle, 0, length, 4096U, 64U);
      util.writeString(num2, baseDirectory, length);
      util.writeUInt(procAddress + 8, 1U);
      util.writeInt(procAddress + 12, num2);
      util.writeInt(procAddress + 16, length);
      int num3 = (int) util.setPageProtect(procAddress, num1, 1);
    ...
    {
      if (File.Exists(Application.StartupPath + "\\content\\scripts\\" + this.lb_script_hub.GetItemText(this.lb_script_hub.SelectedItem)))
      {
    ...
    private void button4_Click(object disposing, [In] EventArgs obj1)
    {
      ...
      if (saveFileDialog.ShowDialog() != DialogResult.OK)
        return;
      File.WriteAllText(saveFileDialog.FileName, this.scintilla1.Text);
      int num;
